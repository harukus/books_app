...
ActiveRecord::Schema.define(version: 20_200_830_072_649) do
  ...
  create_table 'follow_relationships', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index %w[follower_id following_id], name: 'index_follow_relationships_on_follower_id_and_following_id', unique: true
